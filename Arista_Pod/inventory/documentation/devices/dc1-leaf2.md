...
| Ethernet7 | DC1-L2LEAF1_Ethernet4 | *trunk | *- | *- | *- | 7 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_DC1-SPINE1_Ethernet3 | routed | - | 172.31.0.9/31 | default | 1500 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-SPINE2_Ethernet3 | routed | - | 172.31.0.11/31 | default | 1500 | false | - | - |
...
!
interface Ethernet7
   description DC1-L2LEAF1_Ethernet4
   no shutdown
...
| Port-Channel7 | DC1-L2LEAF1_Po3 | switched | trunk | - | - | - | - | - | 7 | - |
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.168.1.5/32 |
...
router bgp 65002
   ...
   neighbor 172.31.0.8 description dc1-spine1_Ethernet3
   neighbor 172.31.0.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.10 description dc1-spine2_Ethernet3
