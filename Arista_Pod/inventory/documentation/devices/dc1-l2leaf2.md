...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.42.0.29/24 | 10.42.0.2 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | DC1-LEAF3_Ethernet6 | *trunk | *- | *- | *- | 1 |
| Ethernet2 | DC1-LEAF4_Ethernet6 | *trunk | *- | *- | *- | 1 |
...
!
interface Ethernet1
   description DC1-LEAF3_Ethernet6
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description DC1-LEAF4_Ethernet6
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | DC1_LEAF2_Po6 | switched | trunk | - | - | - | - | - | - | - |
