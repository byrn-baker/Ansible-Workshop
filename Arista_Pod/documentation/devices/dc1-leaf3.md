...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.42.0.26/24 | 10.42.0.2 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF2 | Vlan4094 | 10.255.252.5 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_dc1-leaf4_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_dc1-leaf4_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet6 | DC1-L2LEAF2_Ethernet1 | *trunk | *- | *- | *- | 6 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_DC1-SPINE1_Ethernet4 | routed | - | 172.31.0.13/31 | default | 9000 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-SPINE2_Ethernet4 | routed | - | 172.31.0.15/31 | default | 9000 | false | - | - |
| Ethernet5 | P2P_LINK_TO_DC1-SPINE3_Ethernet4 | routed | - | 172.31.0.17/31 | default | 9000 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_dc1-leaf4_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_dc1-leaf4_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_dc1-leaf4_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel6 | DC1-L2LEAF2_Po1 | switched | trunk | - | - | - | - | - | 6 | - |
...
interface Port-Channel1
   description MLAG_PEER_dc1-leaf4_Po1
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.0.6/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.168.1.6/32 |
...
| -------- | --------- | --- |
| 10.255.254.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default |
| 172.31.0.12 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.0.14 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.0.16 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 192.168.0.1 | 65001 | default |
| 192.168.0.2 | 65001 | default |
| 192.168.0.3 | 65001 | default |
...
router bgp 65003
   ...
   neighbor 10.255.254.5 description dc1-leaf4
   neighbor 172.31.0.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.12 description dc1-spine1_Ethernet4
   neighbor 172.31.0.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.14 description dc1-spine2_Ethernet4
   neighbor 172.31.0.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.16 description dc1-spine3_Ethernet4
   ...
   neighbor 192.168.0.3 description dc1-spine3
