...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.42.0.24/24 | 10.42.0.2 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF1 | Vlan4094 | 10.255.252.1 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_dc1-leaf2_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_dc1-leaf2_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet6 | DC1-L2LEAF1_Ethernet1 | *trunk | *- | *- | *- | 6 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_DC1-SPINE1_Ethernet2 | routed | - | 172.31.0.1/31 | default | 9000 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-SPINE2_Ethernet2 | routed | - | 172.31.0.3/31 | default | 9000 | false | - | - |
| Ethernet5 | P2P_LINK_TO_DC1-SPINE3_Ethernet2 | routed | - | 172.31.0.5/31 | default | 9000 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_dc1-leaf2_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_dc1-leaf2_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_dc1-leaf2_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_dc1-leaf2_Po1
   no shutdown
   switchport
...
| 172.31.0.0 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.0.2 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.0.4 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
...
router bgp 65002
   ...
   neighbor 10.255.254.1 description dc1-leaf2
   neighbor 172.31.0.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.0 description dc1-spine1_Ethernet2
   neighbor 172.31.0.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.2 description dc1-spine2_Ethernet2
   neighbor 172.31.0.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.4 description dc1-spine3_Ethernet2
