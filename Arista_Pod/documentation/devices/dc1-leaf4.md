...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.42.0.27/24 | 10.42.0.2 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF2 | Vlan4094 | 10.255.252.4 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_dc1-leaf3_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_dc1-leaf3_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet6 | DC1-L2LEAF2_Ethernet2 | *trunk | *- | *- | *- | 6 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_DC1-SPINE1_Ethernet5 | routed | - | 172.31.0.19/31 | default | 9000 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-SPINE2_Ethernet5 | routed | - | 172.31.0.21/31 | default | 9000 | false | - | - |
| Ethernet5 | P2P_LINK_TO_DC1-SPINE3_Ethernet5 | routed | - | 172.31.0.23/31 | default | 9000 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_dc1-leaf3_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_dc1-leaf3_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_dc1-leaf3_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_dc1-leaf3_Po1
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.0.7/32 |
...
| 172.31.0.18 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.0.20 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.0.22 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
...
router bgp 65003
   ...
   neighbor 10.255.254.4 description dc1-leaf3
   neighbor 172.31.0.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.18 description dc1-spine1_Ethernet5
   neighbor 172.31.0.20 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.20 description dc1-spine2_Ethernet5
   neighbor 172.31.0.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.22 description dc1-spine3_Ethernet5
