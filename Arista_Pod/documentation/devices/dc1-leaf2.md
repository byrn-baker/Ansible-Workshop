...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.42.0.25/24 | 10.42.0.2 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF1 | Vlan4094 | 10.255.252.0 | Port-Channel1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | MLAG_PEER_dc1-leaf1_Ethernet1 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet2 | MLAG_PEER_dc1-leaf1_Ethernet2 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 1 |
| Ethernet6 | DC1-L2LEAF1_Ethernet2 | *trunk | *- | *- | *- | 6 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_DC1-SPINE1_Ethernet3 | routed | - | 172.31.0.7/31 | default | 9000 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-SPINE2_Ethernet3 | routed | - | 172.31.0.9/31 | default | 9000 | false | - | - |
| Ethernet5 | P2P_LINK_TO_DC1-SPINE3_Ethernet3 | routed | - | 172.31.0.11/31 | default | 9000 | false | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_dc1-leaf1_Ethernet1
   no shutdown
   channel-group 1 mode active
!
interface Ethernet2
   description MLAG_PEER_dc1-leaf1_Ethernet2
   no shutdown
   channel-group 1 mode active
!
interface Ethernet3
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | MLAG_PEER_dc1-leaf1_Po1 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel6 | DC1-L2LEAF1_Po1 | switched | trunk | - | - | - | - | - | 6 | - |
...
interface Port-Channel1
   description MLAG_PEER_dc1-leaf1_Po1
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.0.5/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.168.1.4/32 |
...
| 172.31.0.6 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.0.8 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
| 172.31.0.10 | Inherited from peer group IPv4-UNDERLAY-PEERS | default |
...
router bgp 65002
   ...
   neighbor 10.255.254.0 description dc1-leaf1
   neighbor 172.31.0.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.6 description dc1-spine1_Ethernet3
   neighbor 172.31.0.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.8 description dc1-spine2_Ethernet3
   neighbor 172.31.0.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.10 description dc1-spine3_Ethernet3
