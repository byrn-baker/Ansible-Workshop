...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.42.0.22/24 | 10.42.0.2 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_DC1-LEAF1_Ethernet4 | routed | - | 172.31.0.2/31 | default | 9000 | false | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-LEAF2_Ethernet4 | routed | - | 172.31.0.8/31 | default | 9000 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-LEAF3_Ethernet4 | routed | - | 172.31.0.14/31 | default | 9000 | false | - | - |
| Ethernet5 | P2P_LINK_TO_DC1-LEAF4_Ethernet4 | routed | - | 172.31.0.20/31 | default | 9000 | false | - | - |
...
interface Ethernet3
   ...
   mtu 9000
   no switchport
   ip address 172.31.0.8/31
!
interface Ethernet4
   description P2P_LINK_TO_DC1-LEAF3_Ethernet4
   no shutdown
   mtu 9000
   no switchport
   ip address 172.31.0.14/31
!
interface Ethernet5
   description P2P_LINK_TO_DC1-LEAF4_Ethernet4
   no shutdown
   mtu 9000
   no switchport
   ip address 172.31.0.20/31
```
...
| 172.31.0.9 | 65002 | default |
| 172.31.0.15 | 65003 | default |
| 172.31.0.21 | 65003 | default |
...
router bgp 65001
   ...
   neighbor 172.31.0.9 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.9 remote-as 65002
   neighbor 172.31.0.9 description dc1-leaf2_Ethernet4
   neighbor 172.31.0.15 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.15 remote-as 65003
   neighbor 172.31.0.15 description dc1-leaf3_Ethernet4
   neighbor 172.31.0.21 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.21 remote-as 65003
   neighbor 172.31.0.21 description dc1-leaf4_Ethernet4
