...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.42.0.21/24 | 10.42.0.2 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_LINK_TO_DC1-LEAF1_Ethernet3 | routed | - | 172.31.0.0/31 | default | 9000 | false | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-LEAF2_Ethernet3 | routed | - | 172.31.0.6/31 | default | 9000 | false | - | - |
| Ethernet4 | P2P_LINK_TO_DC1-LEAF3_Ethernet3 | routed | - | 172.31.0.12/31 | default | 9000 | false | - | - |
| Ethernet5 | P2P_LINK_TO_DC1-LEAF4_Ethernet3 | routed | - | 172.31.0.18/31 | default | 9000 | false | - | - |
...
!
interface Ethernet2
   description P2P_LINK_TO_DC1-LEAF1_Ethernet3
   no shutdown
   mtu 9000
   no switchport
...
!
interface Ethernet3
   description P2P_LINK_TO_DC1-LEAF2_Ethernet3
   no shutdown
   mtu 9000
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_DC1-LEAF3_Ethernet3
   no shutdown
   mtu 9000
   no switchport
   ip address 172.31.0.12/31
!
interface Ethernet5
   description P2P_LINK_TO_DC1-LEAF4_Ethernet3
   no shutdown
   mtu 9000
   no switchport
   ip address 172.31.0.18/31
```
...
| -------- | --------- | --- |
| 172.31.0.1 | 65002 | default |
| 172.31.0.7 | 65002 | default |
| 172.31.0.13 | 65003 | default |
| 172.31.0.19 | 65003 | default |
...
router bgp 65001
   ...
   neighbor 172.31.0.1 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.1 remote-as 65002
   neighbor 172.31.0.1 description dc1-leaf1_Ethernet3
   neighbor 172.31.0.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.7 remote-as 65002
   neighbor 172.31.0.7 description dc1-leaf2_Ethernet3
   neighbor 172.31.0.13 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.13 remote-as 65003
   neighbor 172.31.0.13 description dc1-leaf3_Ethernet3
   neighbor 172.31.0.19 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.0.19 remote-as 65003
   neighbor 172.31.0.19 description dc1-leaf4_Ethernet3
